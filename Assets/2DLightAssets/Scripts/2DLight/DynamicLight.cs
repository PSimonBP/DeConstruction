...
public class DynamicLight : MonoBehaviour
{
	...
	public PolygonCollider2D[]
		allMeshes;								// Array for all of the meshes in our scene
	[HideInInspector]
	public List<verts>
		allVertices = new List<verts>();								// Array for all of the vertices in our meshes
	...
	void setLight()
	{
		...
		for (int i = 0; i < lightSegments; i++) {
			...
			v.pos = new Vector3((Mathf.Sin(theta)), (Mathf.Cos(theta)), 0); // in dregrees (previous calculate)
